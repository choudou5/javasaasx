            ...
            <div class="card-content">
                <div class="toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <button id="addBtn" onclick="FormUtil.bindFormAddBtn('添加第三方消息群')" data-href="${ctx}/message/messageTpGroup/form" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="material-datatables table-responsive">
                    <table id="datatables" class="table table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        ...
                        <c:forEach items="${pageResult.result}" var="item">
                            <tr>
                                <td class="text-right">
                                    <shiro:hasPermission name="message:messageTpGroup:edit">
                                        <a href="javascript:;" onclick="dialogOpenPage('messageTpGroupEdit', '编辑', '${ctx}/message/messageTpGroup/form?id=${item.id}');" class="btn btn-simple btn-warning btn-icon"><i class="fa fa-edit"></i></a>
                                    </shiro:hasPermission>
