                                        ...
                                        <table class="table table-shopping">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="img-container">
                                                            <img src="product1.jpg" tppabs="http://demos.creative-tim.com/material-dashboard-pro/assets/img/product1.jpg" alt="...">
                                                        </div>
                                                    </td>
                                                    <td class="td-name">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="img-container">
                                                            <img src="product2.jpg" tppabs="http://demos.creative-tim.com/material-dashboard-pro/assets/img/product2.jpg" alt="..." />
                                                        </div>
                                                    </td>
                                                    <td class="td-name">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="img-container">
                                                            <img src="product3.jpg" tppabs="http://demos.creative-tim.com/material-dashboard-pro/assets/img/product3.jpg" alt="...">
                                                        </div>
                                                    </td>
                                                    <td class="td-name">
