                ...
                <div class="container-fluid">
                    <div class="header text-center">
                        ...
                        <p class="category">Handcrafted by our friend
                            <a target="_blank" href="javascript:if(confirm(%27https://github.com/mouse0270  \n\nThis file was not retrieved by Teleport Ultra, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27https://github.com/mouse0270%27" tppabs="https://github.com/mouse0270">Robert McIntosh</a>. Please checkout the
                            <a href="javascript:if(confirm(%27http://bootstrap-notify.remabledesigns.com/  \n\nThis file was not retrieved by Teleport Ultra, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://bootstrap-notify.remabledesigns.com/%27" tppabs="http://bootstrap-notify.remabledesigns.com/" target="_blank">full documentation.</a>
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <p>The first step is to create an account at
                                                                            <a href="javascript:if(confirm(%27http://www.creative-tim.com/  \n\nThis file was not retrieved by Teleport Ultra, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://www.creative-tim.com/%27" tppabs="http://www.creative-tim.com/">Creative Tim</a>. You can choose a social network or go for the classic version, whatever works best for you.</p>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="picture">
                                                                            <img src="card-1.jpeg" tppabs="http://demos.creative-tim.com/material-dashboard-pro/assets/img/card-1.jpeg" alt="Thumbnail Image" class="img-rounded img-responsive">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="instruction">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="picture">
                                                                            <img src="card-2.jpeg" tppabs="http://demos.creative-tim.com/material-dashboard-pro/assets/img/card-2.jpeg" alt="Thumbnail Image" class="img-rounded img-responsive">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
