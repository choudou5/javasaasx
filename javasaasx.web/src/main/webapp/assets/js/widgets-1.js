...
(function() {
  ...
  (function() {
      ...
      STMBLPN.Widget.prototype = function() {
        ...
        var followBase = 'http://platform.stumbleupon.com/widgets/follow_badge.php';
        var bestofBase = 'http://platform.stumbleupon.com/widgets/get.php';
        ...
        return {
            ...
            this.domain = opts.domain ? opts.domain.replace(/^\.+/g, '') : 'http://platform.stumbleupon.com/1/stumbleupon.com';
