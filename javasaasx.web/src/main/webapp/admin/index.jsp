                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }US.png" tppabs="/flags/US.png">
                                                </div>
                                            </td>
                                            <td>USA</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }DE.png" tppabs="/flags/DE.png">
                                                </div>
                                            </td>
                                            <td>Germany</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }AU.png" tppabs="/flags/AU.png">
                                                </div>
                                            </td>
                                            <td>Australia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }GB.png" tppabs="/flags/GB.png">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }RO.png" tppabs="/flags/RO.png">
                                                </div>
                                            </td>
                                            <td>Romania</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="${ctxStaticImg }BR.png" tppabs="/flags/BR.png">
                                                </div>
                                            </td>
                                            <td>Brasil</td>
                                            <td class="text-right">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src="${ctxStaticImg }card-2.jpeg">
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
        ...
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src="${ctxStaticImg }card-3.jpeg">
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
        ...
        <div class="col-md-4">
            <div class="card card-product">
                <div class="card-image" data-header-animation="true">
                    <a href="#pablo">
                        <img class="img" src="${ctxStaticImg }card-1.jpeg">
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-actions">
