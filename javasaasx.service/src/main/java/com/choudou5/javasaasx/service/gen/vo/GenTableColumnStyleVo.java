 ...
 * @Date：2018-01-17
 */
public class GenTableColumnStyleVo implements BaseVo<String> {
	...
	public GenTableColumnStyleVo(){
	}

	public GenTableColumnStyleVo(String id){
			setId(id);
	}
	...
	public GenTableColumnStyleVo setTable(String table) {
		this.table = table;
		return this;
	}
