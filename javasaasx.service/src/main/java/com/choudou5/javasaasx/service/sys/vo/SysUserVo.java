 ...
 * @Date：2018-06-03
 */
public class SysUserVo implements BaseVo<String> {
    ...
    private SysUserRelThirdpartyVo tpVo;
    ...
    public SysUserRelThirdpartyVo getTpVo() {
        return tpVo;
    }
    public void setTpVo(SysUserRelThirdpartyVo tpVo) {
        this.tpVo = tpVo;
    }
