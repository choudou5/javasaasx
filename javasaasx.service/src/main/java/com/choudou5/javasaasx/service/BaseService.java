 ...
 * @Date：2018-01-13
 */
public abstract class BaseService<P extends AbstractBasePo, V extends BaseVo> implements com.choudou5.javasaasx.base.service.BaseService<V> {

    protected abstract BaseDao<P, String> getDao();

    @Transactional(readOnly = false)
    @Override
    public void save(V bo) throws BizException {
    ...
    @Transactional(readOnly = false)
    @Override
    public int batchInsert(List<V> list) throws BizException {
        try {
    ...
    @Transactional(readOnly = false)
    @Override
    public void batchUpdate(List<V> list) throws BizException {
        try {
            if (CollUtil.isEmpty(list))
                return;
            if(SysUtil.isDebug())
    ...
    @Override
    public V findOne(QueryParam queryBean) throws BizException {
    ...
    @Override
    public List<V> findList(QueryParam queryBean) throws BizException {
    ...
    @Override
    public List<V> findAll(OrderBean orderBean) throws BizException {
    ...
    @Override
    public List<V> findAll() throws BizException {
    ...
    public PageResult<V> findPage(QueryParam queryBean) throws BizException {
        ...
        PageResult<V> pageResult = new PageResult<>(queryBean.getPageBean().getPageSize(), queryBean.getPageBean().getPageNo());
